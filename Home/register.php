...
<body>
            ...
            <form id="registerForm">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="firstName" name="firstName" placeholder="Nguyễn" required>
                    </div>
                    <div class="form-group">
                        <label for="lastName">Tên</label>
                        <input type="text" id="lastName" name="lastName" placeholder="Văn A" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small style="color: #999; display: block; margin-top: 5px;">Tối thiểu 8 ký tự, chứa chữ hoa, chữ thường và số</small>
                </div>
                ...
                <div class="checkbox-group">
                    ...
                    <label for="terms">Tôi đồng ý với <a href="#" target="_blank">Điều Khoản & Điều Kiện</a> và <a href="#" target="_blank">Chính Sách Bảo Mật</a></label>
                </div>
    ...
    <script>
        ...
        passwordInput.addEventListener('input', function() {
            ...
            const colors = ['#ff4757', '#ffa502', '#ffd32a', '#26de81', '#2ed573'];

            strengthBar.style.width = widths[strength] + '%';
            strengthBar.style.backgroundColor = colors[strength - 1] || '#ff4757';
        });
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!/[a-z]/.test(password) || !/[A-Z]/.test(password) || !/[0-9]/.test(password)) {
                showError('Mật khẩu phải chứa chữ hoa, chữ thường và số');
                return;
            }
            ...
            if (!terms) {
                showError('Vui lòng chấp nhận Điều Khoản & Điều Kiện');
                return;
            }
