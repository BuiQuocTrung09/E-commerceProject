...
<body>
    <div class="container">
        ...
        <div class="login-card">
            ...
            <div class="login-info">
                ...
                Tài khoản của bạn được bảo vệ bằng mã hóa. Vui lòng không chia sẻ mật khẩu của bạn.
            </div>
            ...
            <form id="loginForm">
                <div class="form-group">
                    ...
                    <input type="text" id="email" name="email" placeholder="your.email@example.com" required autofocus>
                </div>
    ...
    <!-- Modal quên mật khẩu -->
    <div id="forgotPasswordModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.5); display: flex; justify-content: center; align-items: center; z-index: 1000;">
        <div style="background: white; padding: 30px; border-radius: 10px; max-width: 400px; width: 90%;">
            <h3 style="margin-bottom: 20px; color: #333;">Đặt Lại Mật Khẩu</h3>
            <p style="color: #666; margin-bottom: 20px; font-size: 14px;">Nhập email của bạn và chúng tôi sẽ gửi hướng dẫn đặt lại mật khẩu</p>
            ...
            <div style="display: flex; gap: 10px;">
                <button onclick="closeModal()" style="flex: 1; padding: 12px; border: 2px solid #e0e0e0; background: white; border-radius: 6px; cursor: pointer; font-weight: 500;">Hủy</button>
                <button onclick="sendResetLink()" style="flex: 1; padding: 12px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">Gửi</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            // Giả lập request (trong thực tế sẽ gửi tới server)
            setTimeout(() => {
                // Xác thực đơn giản (demo)
        ...
        function sendResetLink() {
            ...
            alert('Hướng dẫn đặt lại mật khẩu đã được gửi tới ' + resetEmail);
            closeModal();
        }
